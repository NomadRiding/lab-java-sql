...
SELECT c.Status, a.Aircraft, COUNT(*) AS most_often_booked_aircraft_by_gold_status FROM customers c JOIN airline a ON c.Id = a.Customer_Id WHERE c.Status = 'Gold' GROUP BY c.Status, a.Aircraft ORDER BY most_often_booked_aircraft_by_gold_status DESC LIMIT 1;
